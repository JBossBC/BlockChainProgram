...
func (setup *FabricSetup) InstallAndInstantiateCC() error {
	...
	resp, err := setup.admin.InstantiateCC(setup.ChannelID, resmgmt.InstantiateCCRequest{Name: setup.ChainCodeID, Path: setup.ChaincodeGoPath, Version: "0", Args: [][]byte{[]byte("init"),[]byte("0"),[]byte("0"),[]byte("0")}, Policy: ccPolicy})
